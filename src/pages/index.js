...
const Svg = styled.svg`
  ...
  width: 100px;
  height: 100px;
  animation: spinning 1s 1s 3 alternate backwards;
...
const HeadingLeft = styled.a`
  ...
  animation: fade 0.5s ease-in 0s alternate 1 none running;
